...
print "python Kernel_GraphMatching.py ./SDS_path ./DrugComb_path ./Output_path"
print "======================================"
...
for i in range(0, All_sets_num):
		...
		if(len(Comb_I)>len(Comb_J)):
			Drug_sunsim = Drug_sunsim.transpose()
		Drug_distan = 1 - Drug_sunsim
		row_ind, col_ind = linear_sum_assignment(Drug_distan)
		Total_dis = Drug_distan[row_ind, col_ind].sum()
		Total_sim = Drug_sunsim[row_ind, col_ind].sum()
		Sim_total = Total_sim
		set_sim[i-index_x,j] = Sim_total
